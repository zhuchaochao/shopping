package com.zcc.shopping.cart.utils;
...
import com.zcc.shopping.ShoppingApplication;
...
public class CartStorage {
    ...
    public static CartStorage getInstance(){
        if(instance == null){
            instance = new CartStorage(ShoppingApplication.getContext());
        }
        return instance;
    }
